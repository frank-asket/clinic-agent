...
from data.db import get_all_doctors, get_doctor_by_speciality
...
def get_doctor_info(speciality: str):
...
def generate_time_slots(office_timing: str):
...
def parse_time_slot(slot_str: str) -> str:
    ...
    Returns:
        String like "13:00"
    """
    time_part, suffix = slot_str.strip().split(" ", 1)
    hour, minute = time_part.split(":")
    hour = int(hour)

    if suffix.upper() == "PM" and hour != 12:
        hour += 12
    elif suffix.upper() == "AM" and hour == 12:
        hour = 0
